...
- Issue #31 ("no examples in the schema") was first excluded as an enhancement rather than a bug. It was picked up on 2026-08-24 as User Story 6 — the classification did not change, but its premise turned out to be stale in the same way three of the five defects were. See Clarifications and Assumptions in spec.md.
